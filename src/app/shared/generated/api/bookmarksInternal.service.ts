...
// @ts-ignore
import { BookmarkReorderRequest } from '../model/bookmarkReorderRequest';
// @ts-ignore
...
export class BookmarksInternal {
    ...
    /**
     * Update a bookmark\&#39;s scope to public
     * @param updateBookmark 
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public convertBookmark(updateBookmark: UpdateBookmark, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any>;
    public convertBookmark(updateBookmark: UpdateBookmark, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<any>>;
    public convertBookmark(updateBookmark: UpdateBookmark, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<any>>;
    public convertBookmark(updateBookmark: UpdateBookmark, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        if (updateBookmark === null || updateBookmark === undefined) {
            throw new Error('Required parameter updateBookmark was null or undefined when calling convertBookmark.');
        }
        ...
        let localVarPath = `/bookmarks/convert`;
    ...
    public searchUserBookmarksByCriteria(bookmarkSearchCriteria: BookmarkSearchCriteria, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        let localVarPath = `/bookmarks/user`;
        return this.httpClient.request<BookmarkPageResult>('post', `${this.configuration.basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
                body: bookmarkSearchCriteria,
    ...
    public updateBookmarksOrder(bookmarkReorderRequest: BookmarkReorderRequest, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        let localVarPath = `/bookmarks/reorder`;
        return this.httpClient.request<any>('post', `${this.configuration.basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
                body: bookmarkReorderRequest,
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
                headers: localVarHeaders,
                observe: observe,
