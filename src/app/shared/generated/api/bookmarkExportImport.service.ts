...
// @ts-ignore
import { EximBookmarkScope } from '../model/eximBookmarkScope';
// @ts-ignore
import { EximMode } from '../model/eximMode';
// @ts-ignore
...
export class BookmarkExportImportAPIService {
    ...
    public importBookmarks(requestParameters?: ImportBookmarksRequestParams, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        ...
        if (workspaceName === null || workspaceName === undefined) {
            throw new Error('Required parameter workspaceName was null or undefined when calling importBookmarks.');
        }
        const bookmarkSnapshot = requestParameters?.bookmarkSnapshot;
        if (bookmarkSnapshot === null || bookmarkSnapshot === undefined) {
            throw new Error('Required parameter bookmarkSnapshot was null or undefined when calling importBookmarks.');
        }
        const importMode = requestParameters?.importMode;
        const scopes = requestParameters?.scopes;

        let localVarQueryParameters = new HttpParams({encoder: this.encoder});
        if (importMode !== undefined && importMode !== null) {
          localVarQueryParameters = this.addToHttpParams(localVarQueryParameters,
            <any>importMode, 'importMode');
        }
        if (scopes) {
        ...
        let localVarPath = `/bookmarks/${this.configuration.encodeParam({name: "workspaceName", value: workspaceName, in: "path", style: "simple", explode: false, dataType: "string", dataFormat: undefined})}/import`;
        return this.httpClient.request<any>('post', `${this.configuration.basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
                body: bookmarkSnapshot,
