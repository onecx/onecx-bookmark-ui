...
export const BookmarksSearchActions = createActionGroup({
  ...
  events: {
    'Edit bookmarks button clicked': props<{ id: number | string }>(),
    ...
    'bookmarks search results received': props<{ results: Bookmark[]; totalNumberOfResults: number }>(),
    'bookmarks search results loading failed': props<{ error: string | null }>(),
